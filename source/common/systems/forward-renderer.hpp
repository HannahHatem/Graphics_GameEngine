...
namespace our
{
    ...
    public:
        ...
        void render(World* world, glm::ivec2 viewportStart, glm::ivec2 viewportSize){
            ...
            glm::vec3 cameraForward = glm::normalize(M * glm::vec4(0,0,-1,1) - M * glm::vec4(0,0,0,1));
            std::sort(transparentCommands.begin(), transparentCommands.end(), [cameraForward](const RenderCommand& first, const RenderCommand& second){
                //TODO: Finish this function
                // HINT: the following return should return true "first" should be drawn before "second". 
                //glm::dot(cameraForward,first.center);
                
                if ( glm::dot(cameraForward,first.center) > glm::dot(cameraForward,second.center)) // dist5tance 1  >  distance 2 therefore "fist" object is further from camera 
                {
                    return true;
                }
                return false;
            ...
            glViewport(viewportStart.x,viewportStart.y,viewportSize.x,viewportSize.y); // start on top-left, size width and heigth
            //TODO: Set the clear color to black and the clear depth to 1
            glClearColor(0,0,0,1);
            glClearDepth(1.0f); // z-buffer reset value
